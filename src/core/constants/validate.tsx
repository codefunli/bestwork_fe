...
export const validateForm = yup.object({
  ...
  cpEmail: yup
    ...
    .matches(
      pattern.email,
      getMessage(ERROR_MSG.E01_008, [FieldConstants.EMAIL])
    ),
  cpTelNo: yup
    .string()
    ...
    .matches(
      pattern.telNo,
      getMessage(ERROR_MSG.E01_006, [FieldConstants.TEL_NO])
    ),
  taxNo: yup
    .string()
    ...
    .matches(
      pattern.taxNo,
      getMessage(ERROR_MSG.E01_007, [FieldConstants.TAX_NO])
    ),
  startDate: yup
    .date()
  ...
  expiredDate: yup
    ...
    .min(
      yup.ref("startDate"),
      getMessage(ERROR_MSG.E01_003, [
        FieldConstants.EXPIRED_DATE,
        FieldConstants.START_DATE,
      ])
    ),
  userName: yup
    .string()
    ...
    .matches(
      pattern.userName,
      getMessage(ERROR_MSG.E01_005, [FieldConstants.USER_NAME])
    ),
  password: yup
    .string()
    ...
    .matches(
      pattern.password,
      getMessage(ERROR_MSG.E01_004, [FieldConstants.PASSWORD])
    ),
  uTelNo: yup
    .string()
    .required(getMessage(ERROR_MSG.E01_001, [FieldConstants.TEL_NO]))
    .matches(
      pattern.telNo,
      getMessage(ERROR_MSG.E01_007, [FieldConstants.TEL_NO])
    ),
  uEmail: yup
    .string()
    .required(getMessage(ERROR_MSG.E01_001, [FieldConstants.EMAIL]))
